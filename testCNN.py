...
emoji_dist={0:"emoji/angry.png",1:"emoji/disgusted.png",2:"emoji/fearful.png",3:"emoji/happy.png",4:"emoji/neutral.png",5:"emoji/sad.png",6:"emoji/surprised.png"}
...
def show_vid():    #to open the camera and to record video
    ...
    bound_box = cv2.CascadeClassifier('E:/Downloads/Python/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')#it will detect the face in the video and bound it with a rectangular box
...
def show_vid2():
    print(show_text[0], emoji_dist[show_text[0]])
